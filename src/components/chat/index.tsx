...
export function ChatView() {
	...
	const { selfNodeId, isElecting } = useConnectionState();
	...
	// Show status message during host election
	useEffect(() => {
		if (isElecting) {
			setStatusMessage("Electing new host...");
		} else {
			setStatusMessage(null);
		}
	}, [isElecting, setStatusMessage]);
	...
	return (
		<box flexDirection="column" width={width} height={height} padding={1}>
			...
			<box marginTop={1} flexDirection="column">
				<MessageInput onSend={handleOnSend} disabled={isElecting} />
			</box>
