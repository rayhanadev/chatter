...
export const connectionActions = {
	...
	setElecting: (set: ImmerSetter<ConnectionState>, isElecting: boolean) => {
		set((draft) => {
			draft.isElecting = isElecting;
		});
	},

	setHost: (set: ImmerSetter<ConnectionState>, isHost: boolean) => {
		set((draft) => {
			draft.isHost = isHost;
		});
	},

	setRoomId: (set: ImmerSetter<ConnectionState>, roomId: string) => {
		set((draft) => {
			draft.roomId = roomId;
		});
	},
...
export const chatActions = {
	...
	addSystemMessage: (set: ImmerSetter<ChatState>, message: SystemMessage) => {
		set((draft) => {
