...
import { connectionAtom, chatAtom, uiAtom, peerManagerAtom } from "./atoms";
import { connectionActions, chatActions, uiActions } from "./actions";
import type { PeerInfo, Screen, MenuMode } from "./types";
...
export function useConnectionActions() {
  ...
  return useMemo(
    () => ({
      setConnected: (selfNodeId: string, roomId: string) =>
        connectionActions.setConnected(setConnection, selfNodeId, roomId),
